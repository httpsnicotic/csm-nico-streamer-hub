...
function cloneNotice(item,type){
  const labels={live:'Kick / En vivo',socials:'Redes',culture:'Instagram / Cultura',featured:'Carrusel',clips:'Clips',upcoming:'Próximo stream',announcements:'Anuncio',about:'Sobre mí',custom:'Extra'};
...
function installPreviewSync(){
  ...
  nav?.addEventListener('click',e=>{
    ...
    refreshSimpleFields(panel);renderStats();renderSocials();renderCultureEditor();renderFeatured();renderClips();renderAnnouncements();renderCustomSections();renderSections();bindImages();
